...
function middleware(req, res, next) {
  ...
  try {
    ...
    const userId = decoded.user && decoded.user.id ? decoded.user.id : decoded.id || decoded._id;
    const role = decoded.user && decoded.user.role ? decoded.user.role : decoded.role;
